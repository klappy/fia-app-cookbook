...
The [contextual playback update](poc/CONTEXTUAL-PLAYBACK.md) records the current merged source, local workspace restoration and expanded prepared pack. App PR7 is merged; automatic deployment and exact-revision HTTP readback were verified on 2026-09-12 UTC. The separate inset-controls trial is reviewed but unintegrated and unreleased. Historical test totals remain labeled in the validation record, and mandatory representative whole-guide/Scripture heard quality remains untested.
