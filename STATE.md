...
App main `51e653bc` is publicly verified with 191 prepared Spanish recordings. It retains 34 resources and the two original Spanish Scripture editions. Three proposed AI-derived Scripture editions were withdrawn and are excluded from the authorized runtime and narration. Earlier dated release receipts above remain historical.

Candidate `235072dc79a901a873735f068a4c9bcef83e8b1c` adds the published Door43 Spanish ULB v1.4 as a third edition, with its source provenance and rights retained, and brings prepared Spanish recordings to 204. Its exact version 0.1.9 build passes a 418-file distribution audit. Shared reading screens, disclosure handling and actual clip highlighting are included in this candidate. Merge, deployment and public byte/hash verification remain pending for that revision; local validation is not a public release receipt.
