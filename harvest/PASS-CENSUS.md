...
The [capability register](../poc/CAPABILITIES.md) and [contextual playback record](../poc/CONTEXTUAL-PLAYBACK.md) reconcile existing implementation receipts, preserving historical totals and mandatory acceptance limits. This is a status update to the existing bounded PoC, not a new source harvest. Current app PR7 is merged with deployment verification pending; the separately reviewed inset-controls trial remains unintegrated and unreleased. Exact revision and review receipts remain in the private coordination home.
